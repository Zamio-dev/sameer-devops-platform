...
// Explicitly typed as Variants — this is what fixes the TypeScript error.
// Without the type annotation, TypeScript infers `ease` as `string` (too wide).
// With `Variants`, TypeScript validates "easeOut" as the specific Easing literal.
    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-6 flex justify-center">
          <Badge
            variant="outline"
            className="px-4 py-1.5 text-xs font-mono border-green-500/30 text-green-400 bg-green-500/5"
          >
        ...
        <motion.div variants={itemVariants} className="mb-6">
          <h1 className="text-5xl font-bold tracking-tight sm:text-6xl md:text-7xl">
            ...
            <span className="block font-mono text-primary mt-2">
              DevOps Engineer
            </span>
          </h1>
        </motion.div>
        ...
        >
          Building enterprise-grade cloud infrastructure. RHCSA certified engineer
          specialising in{" "}
        ...
        >
          ...
          <Link href="/terminal">
            <Button
              variant="outline"
              size="lg"
              className="gap-2 font-mono w-full sm:w-auto border-primary/30 hover:border-primary hover:bg-primary/10"
            >
